package com.mirmahfuz.respaycardscanner;
...
public class RespayCardActivity extends Activity {

    protected static final String TAG = RespayCardActivity.class.getSimpleName();
  ...
  /*  private CheckBox mUseCardIOLogoToggle;
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_respay_card);
